...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
    ...
    $nestedData[] = '<td>
                         <center>
                             ...
                             <a onclick="return confirm(\'ingin menghapus data Kode Kabupaten '.$row['kode_kab'].'?\')" href="function/delete.php?aksi=del_kabupaten&kode_kab='.$row['kode_kab'].'" style="font-size:12px;text-decoration:none;"><span class="label label-warning">Delete data</span></a>
                         </center>
                     </td>';
