...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
    ...
    $nestedData[] = '<td>
                         <center>
                             ...
                             <a onclick="return confirm(\'ingin menghapus data ID SDM '.$row['id_sdm'].'?\')" href="function/delete.php?aksi=del_sdm&id_sdm='.$row['id_sdm'].'" style="font-size:12px;text-decoration:none;"><span class="label label-warning">Delete data</span></a>
                         </center>
                     </td>';
